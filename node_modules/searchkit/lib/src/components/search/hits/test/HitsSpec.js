...
describe("Hits component", function () {
    describe('renders correctly', function () {
        beforeEach(function () {
            ...
            _this.wrapper = enzyme_1.mount(React.createElement(Hits_1.Hits, {"searchkit": _this.searchkit, "hitsPerPage": 10, "highlightFields": ["title"], "sourceFilter": ["title"]}));
            _this.pageSizeAccessor = _this.searchkit.accessors.accessors[0];
            _this.highlightAccessor = _this.searchkit.accessors.accessors[1];
            _this.sourceFilterAccessor = _this.searchkit.accessors.accessors[2];
        ...
        it("does render", function () {
            ...
            expect(_this.wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", {"data-qa": "hits", "className": "sk-hits"}, React.createElement("div", {"data-qa": "hit", "className": "sk-hits-hit sk-hits__item"}), React.createElement("div", {"data-qa": "hit", "className": "sk-hits-hit sk-hits__item"}))));
        });
        ...
        it("custom higher order component", function () {
            ...
            expect(wrapper.html()).toEqual(TestHelpers_1.jsxToHTML(React.createElement("div", {"data-qa": "hits", "className": "sk-hits"}, React.createElement("div", {"className": "sk-hits-hit"}, "1"), React.createElement("div", {"className": "sk-hits-hit"}, "2"))));
        });
    });
