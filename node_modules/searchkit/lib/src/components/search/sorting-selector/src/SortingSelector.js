...
var SortingSelector = (function (_super) {
    ...
    SortingSelector.prototype.getSelectedValue = function () {
        var option = this.accessor.getSelectedOption();
        return option && option.label;
    };
    SortingSelector.prototype.render = function () {
        return (React.createElement("div", {"className": this.bemBlocks.container().state({ disabled: !this.hasHits() })}, React.createElement("select", {"onChange": this.updateSorting.bind(this), "value": this.getSelectedValue()}, map(this.props.options, this.renderOption.bind(this)))));
    };
