...
describe("Reset Filter tests", function () {
    beforeEach(function () {
        ...
        _this.createWrapper = function () {
            _this.wrapper = enzyme_1.mount(React.createElement(ResetFilters_tsx_1.ResetFilters, {"searchkit": _this.searchkit, "translations": { "reset.clear_all": "reset filters" }, "options": _this.options}));
