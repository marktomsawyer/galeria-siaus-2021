...
describe("HierarchicalFacetAccessor", function () {
    ...
    it("buildOwnQuery()", function () {
        ...
        var expected = _1.FilterBucket("categories_id", _1.BoolMust([_1.BoolShould(["foo"])]), _1.FilterBucket("lvl1", _1.BoolMust([]), _1.TermsBucket("lvl1", "lvl1", { size: 20, order: order })), _1.FilterBucket("lvl2", _1.BoolMust([
            _1.TermQuery("lvl1", "lvl1val")
        ]), _1.TermsBucket("lvl2", "lvl2", { size: 20, order: order })), _1.FilterBucket("lvl3", _1.BoolMust([
            _1.TermQuery("lvl1", "lvl1val"),
            _1.TermQuery("lvl2", "lvl2val")
        ]), _1.TermsBucket("lvl3", "lvl3", { size: 20, order: order })));
